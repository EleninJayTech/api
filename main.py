...
from Stock.Stock import router as stock_router, stock_today_price, save_corp_code, save_stock_price
...
async def start_scheduler():
    ...
    scheduler.add_job(stock_today_price, 'cron', hour=16, minute=0, second=0)
    # 스케줄러 시작
    scheduler.start()
